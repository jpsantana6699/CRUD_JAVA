...
/**
 * Servlet responsável pela exclusão de itens de mídia.
 * 
...
public class ExcluirItemServlet extends HttpServlet {
    ...
    /**
     * Processa a exclusão de um item pelo ID.
     */
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) 
        ...
        try {
            // Captura o ID do item a ser excluído
    ...
    /**
     * Também aceita POST para exclusão.
     */
    @Override
